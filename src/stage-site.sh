...
# page, every committed file in mark/, social/ and photo/, and the headers and robots
# files beside them. Pure copies -- the Pages build image runs this with nothing installed.
set -eu
out="${1:-public}"
rm -rf "$out"
mkdir -p "$out"
